...
export default function ProfilePage() {
  ...
  const loadUserData = async (): Promise<void> => {
    try {
      ...
      setFormData({
        ...
        goal: userData.goal ?? "",
        weekly_budget: userData.weekly_budget?.toString() ?? ""
      });
    } catch (error) {
  ...
  const calculateAndSaveChanges = async (): Promise<void> => {
            ...
            <Card className="glass-effect border-0 shadow-xl">
              ...
              <CardContent className="space-y-6">
                ...
                <Button
                  ...
                  disabled={isSaving}
                  className="w-full bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 shadow-lg hover-lift"
                  size="lg"
                >
